...
def convert_to_dataset(df):
    ...
    features["label"] = ClassLabel(names=['NO', 'YES'])
...
new_json_path = 'path/directory/sarcasm_dataset.json'
...
# Example usage:
input_file = 'path/directory/sarcasm_dataset.json'
output_file = 'path/directory/final_sarcasm_dataset.json'
